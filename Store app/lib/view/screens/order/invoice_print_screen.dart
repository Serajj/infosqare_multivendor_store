            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    String addOnText = Get.find<OrderController>().getAddOnText(orderDetails![index]);
                    String variationText = Get.find<OrderController>().getVariationText(orderDetails![index]);
                    ...
                    return Padding(
                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Expanded(flex: 6, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(
                          ...
                          (orderDetails![index].itemDetails!.variations != null && orderDetails![index].itemDetails!.variations!.isNotEmpty) ? Text(
