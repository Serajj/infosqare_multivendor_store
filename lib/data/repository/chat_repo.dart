...
class ChatRepo {
  ...
  Future<Response> getMessages(
    ...
    return await apiClient.getData(
        '${AppConstants.getMessageListUri}?offset=$offset&limit=10&${conversationID != null ? 'conversation_id' : userType == AppConstants.deliveryMan ? 'delivery_man_id' : 'user_id'}=${conversationID ?? userId}');
  }
