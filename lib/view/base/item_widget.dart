...
import 'package:connectuz_store/data/model/response/config_model.dart';
...
import 'package:connectuz_store/view/base/custom_loader.dart';
import 'package:connectuz_store/view/base/custom_snackbar.dart';
import 'package:connectuz_store/view/base/discount_tag.dart';
import 'package:connectuz_store/view/base/not_available_widget.dart';
import 'package:connectuz_store/view/base/rating_bar.dart';
...
class ItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        '${isCampaign ? baseUrls!.campaignImageUrl : baseUrls!.itemImageUrl}/${item.image}');
    return InkWell(
