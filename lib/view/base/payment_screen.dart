...
import 'package:connectuz_store/view/base/payment_failed_dialog.dart';
...
import 'fund_payment_dialog.dart';
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    if (widget.addFundUrl == '' && widget.addFundUrl!.isEmpty) {
      //selectedUrl =
      //'${AppConstants.baseUrl}/payment-mobile?customer_id=${widget.orderModel.customer?.id == 0 ? widget.guestId : widget.orderModel.}&order_id=${widget.orderModel.id}&payment_method=${widget.paymentMethod}';
    } else {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Center(
          child: SizedBox(
            width: 1170, //Dimensions.webMaxWidth,
            child: Stack(
              children: [
                _isLoading
                    ? Center(
