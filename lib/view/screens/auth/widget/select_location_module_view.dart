...
import 'package:connectuz_store/view/base/custom_dropdown.dart';
...
class SelectLocationAndModuleView extends StatefulWidget {
  ...
  const SelectLocationAndModuleView(
      {Key? key, required this.fromView, this.mapController})
      : super(key: key);

  @override
  State<SelectLocationAndModuleView> createState() =>
      _SelectLocationAndModuleViewState();
}

class _SelectLocationAndModuleViewState
    extends State<SelectLocationAndModuleView> {
                          ...
                          onTap: () {
                            Get.to(
                              Scaffold(
                                  ...
                                  body: SelectLocationAndModuleView(
                                      fromView: false,
