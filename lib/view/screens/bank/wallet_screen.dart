...
import 'package:connectuz_store/controller/bank_controller.dart';
...
import 'package:connectuz_store/view/screens/bank/widget/wallet_widget.dart';
import 'package:connectuz_store/view/screens/bank/widget/withdraw_request_bottom_sheet.dart';
import 'package:connectuz_store/view/screens/bank/widget/withdraw_widget.dart';
    ...
    return Scaffold(
      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        return GetBuilder<BankController>(builder: (bankController) {
          return authController.modulePermission!.wallet!
                            ...
                            children: [
                              ...
                              bankController.withdrawList!.isNotEmpty
                                  ? ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return WithdrawWidget(
                                          withdrawModel: bankController
                                              .withdrawList![index],
                                          showDivider: index !=
                                              (bankController.withdrawList!
                                                          .length >
                                                      10
                                                  ? 9
                                                  : bankController.withdrawList!
                                  ...
                                  : Center(
                                      ...
                                      child:
                                          Text('no_withdraw_history_found'.tr),
                                    )),
                            ]),
                      ),
                    )
