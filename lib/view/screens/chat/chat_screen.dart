...
import 'package:connectuz_store/view/base/paginated_list_view.dart';
import 'package:connectuz_store/view/screens/chat/widget/message_bubble.dart';
                  ...
                  child: Container(
                    ...
                    child: ClipOval(
                        child: chatController.messageModel != null
                            ? CustomImage(
                                image:
                                    '$baseUrl/${chatController.messageModel!.conversation!.receiver!.image ?? ''}',
                                fit: BoxFit.contain,
                                height: 40,
                                width: 40,
                              )
