...
import 'package:connectuz_store/view/screens/chat/widget/image_dialog.dart';
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: CustomImage(
                        ...
                        height: 40,
                        image:
                            '${userType == AppConstants.customer ? baseUrl!.customerImageUrl : baseUrl!.deliveryManImageUrl}/${user!.image}',
                      ),
                    ),
