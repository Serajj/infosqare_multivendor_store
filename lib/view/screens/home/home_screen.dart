...
import 'package:connectuz_store/view/base/order_shimmer.dart';
import 'package:connectuz_store/view/base/order_widget.dart';
import 'package:connectuz_store/view/screens/home/widget/order_button.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Future<void> _loadData({context}) async {
    ...
    if (context != null) {
      int count = await Get.find<AuthController>().checkFollower();
      if (count == 0) {
        showDialog(
            context: context,
