...
import 'package:connectuz_store/data/model/body/bluetoothPrinterBody.dart';
...
class InvoiceDialog extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    double fontSize = MediaQuery.of(context).size.width > 1000
            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    String addOnText = Get.find<OrderController>()
                        .getAddOnText(orderDetails![index]);
                    String variationText = Get.find<OrderController>()
