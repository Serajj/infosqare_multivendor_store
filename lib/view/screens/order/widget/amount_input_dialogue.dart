...
class AmountInputDialogue extends StatefulWidget {
  ...
  final double? amount;
  const AmountInputDialogue(
      {Key? key,
      required this.orderId,
      required this.isItemPrice,
          ...
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Padding(
                ...
                child: Text(
                  widget.isItemPrice
                      ? 'update_order_amount'.tr
                      : 'update_discount_amount'.tr,
              ...
              GetBuilder<OrderController>(builder: (orderController) {
                return !orderController.isLoading
                    ? CustomButton(
                        ...
                        onPressed: () {
                          orderController.updateOrderAmount(
                              widget.orderId,
