...
class ItemDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isGrocery = Get.find<AuthController>()
            .profileModel!
            .stores![0]
            .module!
            .moduleType ==
            ...
            Expanded(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height:
                            module.stock! ? Dimensions.paddingSizeLarge : 0),
                  ...
                  ? CustomButton(
                      onPressed: () async {
                        if (Get.find<AuthController>()
                            ...
                            .itemSection!) {
                          Item? items =
                              await storeController.getItemDetails(item.id!);
                          if (items != null) {
                            Get.toNamed(RouteHelper.getItemRoute(items));
                          }
                        } else {
                          showCustomSnackBar(
...
class VariationView extends StatelessWidget {
  final Item item;
  final bool? stock;
  const VariationView({Key? key, required this.item, required this.stock})
      : super(key: key);
          ...
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Row(children: [
                  ...
                  SizedBox(
                      width: stock! ? Dimensions.paddingSizeExtraSmall : 0),
                  stock!
                      ? Text(
