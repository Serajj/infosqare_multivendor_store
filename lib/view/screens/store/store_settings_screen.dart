...
import 'package:connectuz_store/view/base/custom_drop_down.dart';
import 'package:connectuz_store/view/base/custom_snackbar.dart';
import 'package:connectuz_store/view/base/my_text_field.dart';
import 'package:connectuz_store/view/base/switch_button.dart';
import 'package:connectuz_store/view/screens/store/widget/daily_time_widget.dart';
            ...
            child: Column(children: [
              ...
              widget.store.module!.moduleType.toString() == 'food'
                  ? SwitchButton(
                      icon: Icons.flatware,
                      title: 'cutlery'.tr,
                      isButtonActive: widget.store.cutlery,
                      onTap: () {
              ...
              _store.selfDeliverySystem == 1
                  ? SwitchButton(
                      ...
                      isButtonActive: widget.store.freeDelivery,
                      onTap: () {
              ...
              (widget.store.module!.moduleType.toString() == 'pharmacy' &&
                  ...
                  ? SwitchButton(
                      ...
                      isButtonActive: widget.store.prescriptionStatus,
                      onTap: () {
