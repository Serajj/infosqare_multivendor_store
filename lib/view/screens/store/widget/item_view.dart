...
import 'package:connectuz_store/view/base/item_shimmer.dart';
import 'package:connectuz_store/view/base/item_widget.dart';
import 'package:connectuz_store/view/screens/store/widget/veg_filter_widget.dart';
      ...
      if (scrollController.position.pixels ==
        ...
        if (Get.find<StoreController>().offset < pageSize) {
          Get.find<StoreController>()
              .setOffset(Get.find<StoreController>().offset + 1);
